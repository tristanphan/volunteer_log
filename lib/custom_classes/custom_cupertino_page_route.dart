...
///  * [NewCupertinoPageRoute], which is a [PageRoute] that leverages this mixin.
mixin CupertinoRouteTransitionMixin<T> on PageRoute<T> {
  ...
  /// The title string of the previous [NewCupertinoPageRoute].
  ///
  ...
  /// is not a [NewCupertinoPageRoute].
  ///
  /// See also:
  ///
  ...
  ///
  /// Used by [NewCupertinoPageRoute.buildTransitions].
  ///
  /// This method can be applied to any [PageRoute], not just
  /// [NewCupertinoPageRoute]. It's typically used to provide a Cupertino style
...
class NewCupertinoPageRoute<T> extends PageRoute<T> with CupertinoRouteTransitionMixin<T> {
...
/// See also:
///
///  * [NewCupertinoPageRoute], for a [PageRoute] version of this class.
...
///
/// This is created by a [NewCupertinoPageRoute] in response from a gesture caught
